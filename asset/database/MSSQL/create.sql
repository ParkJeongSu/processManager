...
(
 ...
 SYSTEM_NAME varchar(40) NOT NULL, --[ MNG | WCS | EAS ]
 PROCESS_GROUP_NAME varchar(40) NOT NULL, -- [ PEX | TEX | EAS | WCS ]
 PROCESS_NAME varchar(40) NOT NULL,
 DESCRIPTION varchar(400),
 COPY_DIR varchar(400),
 WORKING_DIR varchar(400),
...
(
 PORT int PRIMARY KEY ,
 PROCESS_NAME varchar(40) NOT NULL,
 STATUS varchar(400), -- [ STOPPED | STARTING | RUNNING | STOPPING ]
 PID int,
 START_REQUEST_TIME datetime2,
 START_TIME datetime2,
 END_REQUEST_TIME datetime2,
 END_TIME datetime2,
);
...
(
 ...
 END_REQUEST_TIME datetime2,
 END_TIME datetime2,
 EVENT_USER varchar(400)
);

ALTER TABLE PROCESS_STATUS_HISTORY ADD CONSTRAINT PK_PROCESS_STATUS_HISTORY PRIMARY KEY (EVENT_TIME, PORT);
